...
const SpirographIcon = () => {
  ...
  return (
    <svg width="120" height="120" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#EB8B58] hover:[animation:spin_1s_linear_infinite] [animation:spin_5s_linear_infinite]">
