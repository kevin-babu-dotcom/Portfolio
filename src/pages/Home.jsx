    ...
    <div className="bg-transparent p-2 h-full md:py-3 py-8 md:my-2  mx-auto md:flex-col flex w-full md:p-0 ">
      <div className=" md:grid grid-cols-[58.6fr_34.5fr] grid-rows-1 md:gap-4  h-full w-full ">
        ...
        <div className="md:grid grid-rows-[56.9fr_43.1fr] grid-cols-9 md:gap-4 h-full flex-1 col-start-1 ">
            ...
            <div className="PassionCard md:p-0 p-2 bg-white col-span-6 border shadow-[0_0_30px_rgba(255,255,255,0.6)] row-start-1 h-full w-full rounded-3xl md:relative  flex  md:overflow-hidden  flex-col items-center justify-center">
            ...
            {/* Corrected ImageCard */}
            <div className="ImageCard bg-white rounded-3xl border shadow-[0_0_30px_rgba(255,255,255,0.6)] my-10 md:my-0 h-[300px] md:h-full w-full md:col-span-3 overflow-hidden md:row-start-1">
              <img 
                src={potrait}
            ...
            <div   className="ContactCard bg-orange-300 rounded-3xl border text-shadow-glow shadow-[0_0_30px_rgba(255,255,255,0.6)] md:row-start-2 md:col-span-5 md:p-5 p-10 h-full w-full md:relative  flex flex-col">
            ...
            <div  className="SpotifyCard bg-white rounded-3xl border shadow-[0_0_30px_rgba(255,255,255,0.6)] h-full w-full flex md:p-5 col-span-4 row-start-2 p-10 my-10 md:my-0 ">
        ...
        <div className="md:grid grid-rows-[46.9fr_42.7fr_12.2fr] grid-cols-1 col-start-2 gap-4 h-full flex-1">
            ...
            <div className="CodeCard  bg-white border shadow-[0_0_30px_rgba(255,255,255,0.6)]  rounded-3xl h-full w-full">
              <img  src={code}  alt="A beautiful landscape"  className=" scale-85 object-cover h-full w-full rounded-2xl"  /> 
            </div>

            <div className="AboutCard text-shadow-glow bg-white border shadow-[0_0_30px_rgba(255,255,255,0.6)] rounded-3xl md:relative flex flex-col h-full w-full my-10 md:my-0 md:p-0 p-8">
            ...
            <div className="SocialsCard bg-[#6C6594] shadow-[0_0_30px_rgba(255,255,255,0.6)] rounded-3xl flex border justify-between h-full w-full p-4 gap-4 ">
